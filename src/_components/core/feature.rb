class Core::Feature < Bridgetown::Component
  ...
  def items
    [
      { number: '01', title: '公式サイト制作・リニューアル', summary: '施設の印象をスマホ前提で整える', image: 'https://images.unsplash.com/photo-1611892440504-42a792e24d32?auto=format&fit=crop&w=900&q=80', alt: 'レジャーホテルの客室イメージ', body: '古く見えるトップページや分かりにくい客室情報を整理し、初めてのお客様にも安心感が伝わる公式サイトに作り直します。客室写真、料金、設備、アクセス、予約導線を一つの流れで見やすく設計します。' },
