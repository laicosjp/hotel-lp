class Core::Reason < Bridgetown::Component
  ...
  def items
    [
      { title_html: '<span>スマホで見やすい設計</span>で<br />来店前の不安を減らす', image: 'sec02_p1.png', alt: 'スマホで見やすい設計', body: 'レジャーホテルを探すお客様はスマホで比較します。料金、休憩・宿泊時間、設備、部屋写真、アクセスを迷わず見られる構成に整えます。' },
      { title_html: '<span>レジャーホテルの見られ方</span>に合わせた<br />情報整理', image: 'sec02_p2.png', alt: 'レジャーホテルの情報整理', body: '一般的なホテルサイトではなく、初めてのお客様が気にする清潔感、入りやすさ、料金の分かりやすさ、設備の安心感を軸にページを作ります。' },
